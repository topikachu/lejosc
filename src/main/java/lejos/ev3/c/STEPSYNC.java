 ...
 */
public class STEPSYNC extends Structure {
	/** C type : DATA8 */
	public byte Cmd;
	public byte getCmd() {
		return Cmd;
	 ...
	 * @param Turn C type : DATA16<br>
	 * @param Step C type : DATA32<br>
	 * @param Brake C type : DATA8
	 */
	public STEPSYNC(byte Cmd, byte Nos, byte Speed, short Turn, int Step, byte Brake) {
		super();
		this.Cmd = Cmd;
		this.Nos = Nos;
		this.Speed = Speed;
	...
	public static class ByReference extends STEPSYNC implements Structure.ByReference {
		
	};
	public static class ByValue extends STEPSYNC implements Structure.ByValue {
